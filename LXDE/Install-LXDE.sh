...
echo $line
echo "Starting LXDE installation..."
...
sudo apt-get install --no-install-recommends lxde -y
echo $line
...
# create a 2gb file using dd at /roms/tools/swapfile, test if file already exists
...
echo "You may start LXDE by opening LAUNCH-LXDE in the tools menu."
